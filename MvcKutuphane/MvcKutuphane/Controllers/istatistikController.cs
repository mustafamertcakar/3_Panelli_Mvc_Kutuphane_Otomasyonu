...
namespace MvcKutuphane.Controllers
{
    public class istatistikController : Controller
    {
        ...
        public ActionResult LinqKart()
        {
            ...
            var deger6 = db.TBLHAREKET.GroupBy(x => x.TBLUYELER.AD).OrderByDescending(z => z.Count()).Select(y => new { y.Key }).FirstOrDefault().Key;
            ...
            var deger12 = db.BugunEmanetEdilenKitaplar().FirstOrDefault();
            ViewBag.dgr1 = deger1;
            ViewBag.dgr2 = deger2;
            ViewBag.dgr3 = deger3;
            ViewBag.dgr4 = deger4;
