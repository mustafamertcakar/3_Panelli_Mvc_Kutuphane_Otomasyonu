...
namespace MvcKutuphane.Models.Entity
{
    ...
    public partial class DBKUTUPHANEEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> BugunEmanetEdilenKitaplar()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("BugunEmanetEdilenKitaplar");
        }
